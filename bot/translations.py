BOT_TEXTS = {
    "uz": {
        ...
        "stranger_join_prompt": "👋 {mention}, xush kelibsiz! Guruhga rasmiy ro'yxatdan o'tmasdan qo'shilgan ko'rinasiz.\n\nRasmiy volontyor bo'lish uchun:\n1️⃣ Botni shaxsiy xabarlarda ishga tushiring: https://t.me/DuoCharityBot\n2️⃣ Anketani to'ldiring: {form_link}\n\nShunda administratsiya arizangizni ko'rib chiqadi. 🤝",
    ...
    "ru": {
        ...
        "stranger_join_prompt": "👋 {mention}, добро пожаловать! Похоже, вы вступили в группу напрямую, без официальной регистрации.\n\nЧтобы стать официальным волонтёром:\n1️⃣ Запустите бота в личных сообщениях: https://t.me/DuoCharityBot\n2️⃣ Заполните анкету: {form_link}\n\nПосле этого администрация рассмотрит вашу заявку. 🤝",
        "change_language_prompt": "Tilni tanlang / Выберите язык:",
